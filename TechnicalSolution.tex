...
The LED and infra-red lights are controlled by Phidgets. %reference?
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{mikkertest2}
\caption{Data gathering on test-subject.}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{spencertest}
\caption{Data gathering on test-subject.}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{petertest}
\caption{Data gathering on test-subject.}
\label{fig:petertest}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[angle=90,width=0.8\textwidth]{nielstest}
\caption{Data gathering on test-subject.}
\label{fig:nielstest}
\end{figure}
